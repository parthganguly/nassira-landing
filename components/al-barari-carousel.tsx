...
// Start at 29.png → 35.png, then continue from 2.png → 28.png (1.png not present in folder)
const images = [
  ...Array.from({ length: 7 }, (_, i) => `/al barari/${29 + i}.png`),
  ...Array.from({ length: 27 }, (_, i) => `/al barari/${2 + i}.png`),
]

export function AlBarariCarousel() {
  ...
  return (
    <div className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden shadow-lg">
      <Image src={images[current]} alt="Al Barari Villa" fill className="object-cover" priority />
...
export default AlBarariCarousel
